...
<%@ include file="/animateur/menu.jspf" %>
	...
	<input type="text" name="tIdentifiant" readonly="readonly" size="10" value="<jsp:getProperty property="id" name="formationCourante"/>"/>
	</div>
	...
	<input type="text" name="tDescription" size="30" value="<jsp:getProperty property="description" name="formationCourante"/>"/>
	</div>
